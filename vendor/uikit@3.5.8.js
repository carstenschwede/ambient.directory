    ...
    */
    ...
    function boot (UIkit) {
        ...
        function init() {
			...
			window.disableUIKitUpdates = function() {
				window.uikitUpdatesDisabled = true;
			};
			window.enableUIKitUpdates = function() {
				window.uikitUpdatesDisabled = false;
			};
            ...
            (new MutationObserver(function (mutations) {
				if (window.uikitUpdatesDisabled) return;// console.warn("UIKITUPDATES DISABLED");
				//console.warn("UIKITUPDATES ENABLED");
                var updates = [];
